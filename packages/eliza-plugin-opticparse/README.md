...
- **`PHISHVISION_PREFLIGHT_GUARD` Action:** Pre-flight cybersecurity scan that detects zero-day phishing kits, crypto drainers, and adversarial prompt injections before an agent navigates to an untrusted URL.
